    ...
    func updateButtonAction() {
        ...
        if (self.isUpdateEmail) {
            ...
            SSAuthenticationManager.sharedInstance.emailValidate(email: email) { (bool: Bool, statusCode: Int, error: NSError?) in
                if (bool) {
                    SSAuthenticationManager.sharedInstance.updateEmail(userDictionary: userDict) { (user: SSUser?, statusCode: Int, error: NSError?) in
                        if (user != nil) {
            ...
            SSAuthenticationManager.sharedInstance.updatePassword(userDictionary: userDict) { (user: SSUser?, statusCode: Int, error: NSError?) in
                if (user != nil) {
